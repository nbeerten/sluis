...
function generate_representation_audio(Format: streams_videoId["audioStreams"][number]) {
...
function generate_representation_video(Format: streams_videoId["videoStreams"][number]) {
    const representation = {
        _id: Format.itag,
        _codecs: Format.codec,
        _bandwidth: Format.bitrate,
